...
export default function Navbar() {
    ...
    return (
        <nav className="w-full h-20 flex justify-between items-center fixed z-[50] px-6 sm:px-12 md:px-24 py-4 bg-primary bg-opacity-80 backdrop-blur-sm  ">
            ...
            <div className="flex">
                <img src="/icons/france.png" alt="Francais" className="hidden mr-2 lg:flex w-[26px] h-[26px]  hover:scale-105 app_transition cursor-pointer"/>
                <p className="text-white">|</p>
                <img
                src="/icons/united-states-of-america.png"
                alt="Anglais"
                className="hidden lg:flex w-[26px] h-[26px] ml-2 hover:scale-105 app_transition cursor-pointer"
            />
            </div>
